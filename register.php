                            ...
                            <div id="steps-container">
                                ...
                                <div class="step">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control col-md-6" name="username" id="username" placeholder="Uporabniško ime..." autocomplete="off" required data-bs-toggle="tooltip" data-bs-placement="bottom" title="Uporabniško ime mora biti dolgo vsaj 4 znake!" <?php if (isset($_GET['error'])):?>value="<?=$_GET['user']?>" <?php endif; ?>>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label text-md-right" for="email">Elektronska pošta:*</label>
                                        <input type="email" class="form-control col-md-6" name="email" id="email" placeholder="Elektronska pošta..." required <?php if (isset($_GET['error'])):?>value="<?=$_GET['email']?>" <?php endif; ?> >
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label text-md-right" for="password">Geslo:*</label>
                                        <input type="password" class="form-control col-md-6" name="password" id="password" placeholder="Geslo..." autocomplete="off" required data-bs-toggle="tooltip" data-bs-placement="bottom" title="Vsebovati mora eno veliko črko, eno malo črko, številko in znak!">
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="step">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control col-md-6" name="firstName" id="firstName" placeholder="Ime..." autocomplete="off" required <?php if (isset($_GET['error'])):?>value="<?=$_GET['fname']?>" <?php endif; ?>>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label text-md-right" for="lastName">Priimek:*</label>
                                        <input type="text" class="form-control col-md-6" name="lastName" id="lastName" placeholder="Priimek..." autocomplete="off" required <?php if (isset($_GET['error'])):?>value="<?=$_GET['lname']?>" <?php endif; ?>>
                                    </div>
                                
                                    <!-- Phone number -->
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label text-md-right" for="phoneNumber">Telefon:</label>
                                        <input type="text" class="form-control col-md-6" name="phoneNumber" id="phoneNumber" placeholder="Telefonska stevilka..." autocomplete="off" <?php if (isset($_GET['error'])):?>value="<?=$_GET['phone']?>" <?php endif; ?>>
                                    </div>
                                </div> <!-- step -->
                                ...
                                <div class="step">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="text" class="form-control col-md-6" name="addressOne" id="addressOne" placeholder="Naslov..." autocomplete="off" required <?php if (isset($_GET['error'])):?>value="<?=$_GET['addr']?>" <?php endif; ?>>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label text-md-right" for="addressTwo">Naslov 2:</label>
                                        <input type="text" class="form-control col-md-6" name="addressTwo" id="addressTwo" placeholder="Naslov..." autocomplete="off" <?php if (isset($_GET['error'])):?>value="<?=$_GET['addrsec']?>" <?php endif; ?>>
                                    </div>
                                    <!-- Postal code -->
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label text-md-right" for="postalCode">Poštna številka:*</label>
                                        <input type="text" class="form-control col-md-6" name="postalCode" id="postalCode" placeholder="Postna stevilka..." autocomplete="off" required <?php if (isset($_GET['error'])):?>value="<?=$_GET['postalCode']?>" <?php endif; ?>>
                                    </div>
                                    <!-- City -->
                                    <div class="form-group row">
                                        <label class="col-md-4 col-form-label text-md-right" for="city">Mesto:*</label>
                                        <input type="text" class="form-control col-md-6" name="city" id="city" placeholder="Mesto..." autocomplete="off" required <?php if (isset($_GET['error'])):?>value="<?=$_GET['city']?>" <?php endif; ?>>
                                    </div>
                                    <!-- Country -->
                                    <div class="form-group row">
